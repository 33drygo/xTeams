...
public class XTeamsCommand implements CommandExecutor {
    ...
    private boolean handleInfo(CommandSender sender) {
        ...
        sender.sendMessage(ChatUtils.formatColor("&f            #7070701. #FFFAABPlaceholders now work correctly"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABon premium servers"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070702. #FFFAABScoreboard team names now match"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABthe display name you set"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070703. #FFFAAB/xteams reload now applies hook"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABchanges without restarting"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070704. #FFFAAB/xteams sync now reaches every"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABonline team member"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070705. #FFFAABFaster server startup — update"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABcheck no longer blocks it"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070706. #FFFAABTab suggestions narrow down"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABas you type"));
        sender.sendMessage(ChatUtils.formatColor("&f            #7070707. #FFFAABMore stable: fewer crashes from"));
        sender.sendMessage(ChatUtils.formatColor("&f            #707070   #FFFAABedge cases and bad config values"));
        sender.sendMessage(ChatUtils.formatColor("&7"));
        sender.sendMessage(ChatUtils.formatColor("#fff18d&l               ᴅʀʏɢᴏ'ꜱ ɴᴏᴛᴇ ᴏꜰ ᴛʜᴇ ᴠᴇʀꜱɪᴏɴ"));
        sender.sendMessage(ChatUtils.formatColor("&f  #FFFAAB         A round of polishing — bugs squashed,"));
        sender.sendMessage(ChatUtils.formatColor("&f  #FFFAAB         startup is faster, and reload finally"));
        sender.sendMessage(ChatUtils.formatColor("&f  #FFFAAB         does what you'd expect. Enjoy!"));
        sender.sendMessage(ChatUtils.formatColor("&7"));
        sender.sendMessage(ChatUtils.formatColor("&7"));
        return true;
    }
